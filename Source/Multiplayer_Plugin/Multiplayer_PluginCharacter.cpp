...
void AMultiplayer_PluginCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void AMultiplayer_PluginCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AMultiplayer_PluginCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AMultiplayer_PluginCharacter::Look);
	}
	else
	{
...
void AMultiplayer_PluginCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AMultiplayer_PluginCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
